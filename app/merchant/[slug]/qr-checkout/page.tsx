    ...
    <div className="p-4 sm:p-6">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#2D2721]">QR Instant Checkout</h1>
        ...
        <div className="bg-white rounded-2xl border border-[#e8e0d8] p-6 mb-6">
          <label className="block text-sm font-medium text-[#2D2721] mb-2">
            Link to voucher (optional)
          </label>
          <select
            value={selectedVoucher}
            onChange={(e) => setSelectedVoucher(e.target.value)}
            className="w-full border border-[#e8e0d8] rounded-xl px-4 py-3 text-[#2D2721] bg-[#faf8f5] focus:outline-none focus:ring-2 focus:ring-[#FFC857] mb-4"
          >
        ...
        {qrDataUrl && (
          <div className="bg-white rounded-2xl border border-[#e8e0d8] p-8 text-center print:border-none print:shadow-none">
            <img src={qrDataUrl} alt="Checkout QR Code" className="mx-auto mb-4" style={{ width: 240, height: 240 }} />
