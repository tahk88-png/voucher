...
import type { RouteAccess } from '@/figma/app/contexts/AuthContext';
...
export const FIGMA_ROUTES: FigmaRoute[] = [
  ...
  { title: 'Merchant Dashboard', path: '/dashboard', component: MerchantDashboard, layout: 'dashboard', access: 'merchant' },
  { title: 'Storefront Editor', path: '/store-builder', component: StorefrontEditor, layout: 'dashboard', access: 'merchant' },
  { title: 'Integrations', path: '/integrations', component: IntegrationsSettings, layout: 'dashboard', access: 'merchant' },
  { title: 'User Dashboard', path: '/user-dashboard', component: UserDashboard, layout: 'dashboard', access: 'user' },
  { title: 'Admin Dashboard', path: '/admin-dashboard', component: AdminDashboard, layout: 'dashboard', access: 'admin' },
  { title: 'Email Templates', path: '/admin/email-templates', component: EmailTemplates, layout: 'dashboard', access: 'admin' },
  { title: 'Analytics', path: '/analytics', component: Analytics, layout: 'dashboard', access: 'merchant' },
  { title: 'Product Create', path: '/products/create', component: ProductCreate, layout: 'dashboard', access: 'merchant' },
  { title: 'Order Create', path: '/orders/create', component: CreateOrder, layout: 'dashboard', access: 'merchant' },
  { title: 'Multi Scanner', path: '/multi-scanner', component: MultiScannerDashboard, layout: 'dashboard', access: 'merchant' },
  { title: 'Campaigns List', path: '/campaigns-list', component: CampaignsList, layout: 'dashboard', access: 'merchant' },
  { title: 'Campaign Admin Detail', path: '/campaigns/:id/admin', component: CampaignAdminDetail, layout: 'dashboard', access: 'merchant' },
  { title: 'Campaign Create', path: '/campaigns/create', component: CampaignCreate, layout: 'dashboard', access: 'merchant' },
  { title: 'Campaign Create Alias', path: '/create-campaign', component: CampaignCreate, layout: 'dashboard', access: 'merchant' },
  { title: 'News Create', path: '/news/create', component: NewsCreate, layout: 'dashboard', access: 'merchant' },
  { title: 'Vouchers List', path: '/vouchers', component: VouchersList, layout: 'dashboard', access: 'merchant' },
  { title: 'Voucher Create', path: '/vouchers/create', component: VoucherCreate, layout: 'dashboard', access: 'merchant' },
  { title: 'Discount Codes', path: '/discounts', component: DiscountCodes, layout: 'dashboard', access: 'merchant' },
  { title: 'Gift Cards List', path: '/gift-cards', component: GiftCardsList, layout: 'public-catalog' },
  { title: 'Gift Card Create', path: '/gift-cards/create', component: GiftCardCreate, layout: 'dashboard', access: 'merchant' },
  { title: 'Events List', path: '/events', component: EventsList, layout: 'public-catalog' },
  { title: 'Event Create', path: '/events/create', component: EventCreate, layout: 'dashboard', access: 'merchant' },
  { title: 'Event Detail', path: '/events/:id', component: EventDetail, layout: 'dashboard', access: 'merchant' },
  { title: 'Event Edit', path: '/events/:id/edit', component: EventCreate, layout: 'dashboard', access: 'merchant' },
  { title: 'Promotions', path: '/promotions', component: Promotions, layout: 'dashboard', access: 'merchant' },
  { title: 'Bonus Accounting', path: '/bonus-accounting', component: BonusAccounting, layout: 'dashboard', access: 'merchant' },
  { title: 'Share', path: '/share', component: Share, layout: 'dashboard', access: 'merchant' },
  { title: 'User Share', path: '/user-share', component: UserShare, layout: 'dashboard', access: 'user' },
  { title: 'Referrals', path: '/referrals', component: Referrals, layout: 'dashboard', access: 'user' },
  { title: 'Wallet', path: '/wallet', component: Wallet, layout: 'dashboard', access: 'user' },
  { title: 'Merchant Wallet', path: '/merchant-wallet', component: MerchantWallet, layout: 'dashboard', access: 'merchant' },
  { title: 'Email Composer', path: '/email-composer', component: EmailComposer, layout: 'dashboard', access: 'merchant' },
  { title: 'Notifications', path: '/notifications', component: Notifications, layout: 'dashboard', access: 'authenticated' },
  { title: 'Billing', path: '/billing', component: Billing, layout: 'dashboard', access: 'merchant' },
  { title: 'QR Codes', path: '/qr-codes', component: QRCodes, layout: 'dashboard', access: 'merchant' },
  { title: 'Mobile Scanner', path: '/mobile-scanner', component: MobileScanner, layout: 'dashboard', access: 'merchant' },
  { title: 'Settings', path: '/settings', component: Settings, layout: 'dashboard', access: 'authenticated' },
  { title: 'Advanced Settings', path: '/advanced-settings', component: AdvancedSettings, layout: 'dashboard', access: 'authenticated' },
  { title: 'Merchant Onboarding', path: '/merchant-onboarding', component: MerchantOnboarding, layout: 'dashboard', access: 'merchant' },
  { title: 'Subscription Plans', path: '/subscription-plans', component: SubscriptionPlans, layout: 'dashboard', access: 'merchant' },
  { title: 'Subscription Success', path: '/subscription-success', component: SubscriptionSuccess, layout: 'dashboard', access: 'merchant' },
  { title: 'Subscription Manage', path: '/subscription-manage', component: SubscriptionManage, layout: 'dashboard', access: 'merchant' },
  { title: 'Communication Hub', path: '/extra/communication-hub', component: CommunicationHub, layout: 'dashboard', access: 'merchant' },
  { title: 'Finance Manager', path: '/extra/finance-manager', component: FinanceManager, layout: 'dashboard', access: 'merchant' },
  { title: 'Logistics Manager', path: '/extra/logistics-manager', component: LogisticsManager, layout: 'dashboard', access: 'merchant' },
  { title: 'Order Manager', path: '/extra/order-manager', component: OrderManager, layout: 'dashboard', access: 'merchant' },
  { title: 'Product Manage', path: '/extra/product-manage', component: ProductManage, layout: 'dashboard', access: 'merchant' },
  { title: 'Rental Manage', path: '/extra/rental-manage', component: RentalManage, layout: 'dashboard', access: 'merchant' },
  { title: 'Warehouse', path: '/extra/warehouse', component: WarehousePage, layout: 'dashboard', access: 'merchant' },
  { title: 'Component Showcase', path: '/extra/components', component: ComponentShowcase, layout: 'dashboard', access: 'merchant' },
  { title: 'Domain Settings', path: '/extra/domain-settings', component: DomainSettings, layout: 'dashboard', access: 'merchant' },
