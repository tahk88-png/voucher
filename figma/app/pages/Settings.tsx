...
export function Settings() {
  ...
  const [isEditingLocation, setIsEditingLocation] = useState<string | null>(
    null,
  );
  ...
  const [formData, setFormData] = useState({
    ...
    deliveryCourierPrice: 5.9,
    deliveryFreeThreshold: 50.0, // New field
    deliverySmartpostAllowed: true,
    deliverySmartpostPrice: 2.9,
    deliveryOmnivaAllowed: true,
    deliveryOmnivaPrice: 2.5,
  });
    ...
    <div className="space-y-6 max-w-3xl pb-12 motion-safe:animate-fade-up">
      ...
      <div>
        ...
        <p className="text-[#6B5744] mt-1">
          Halda oma poe seadeid, tarneviise ja asukohti
        </p>
      </div>
      ...
      <WarmCard padding="lg" className="border-l-4 border-l-[#FFC857]">
        ...
        <div className="space-y-4">
          {locations.map((loc) => (
            <div
              key={loc.id}
              className="bg-white p-4 rounded-xl border border-[#E7DCC7] flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-sm hover:shadow-md transition-all"
            >
                ...
                <div>
                  ...
                  <div className="text-sm text-[#6B5744] flex flex-col gap-1 mt-1">
                    <span className="flex items-center gap-1">
                      <MapPin className="w-3 h-3" /> {loc.address}, {loc.city}
                    </span>
                    <span className="flex items-center gap-1">
              ...
              <div className="flex items-center gap-2 self-end sm:self-center">
                ...
                <button
                  ...
                  className="p-2 hover:bg-[#FFF9ED] text-[#E17B5C] rounded-lg transition-colors"
                >
          ...
          {isEditingLocation === "new" ? (
            <div className="bg-[#FAF7F2] p-4 rounded-xl border border-[#E7DCC7] animate-in slide-in-from-top-2">
              <h3 className="font-bold text-[#2D2721] mb-3">
                Lisa uus asukoht
              </h3>
        ...
        <div className="space-y-6 motion-safe:animate-fade-up">
          ...
          <div className="bg-[#FFF9ED] p-4 rounded-xl border border-[#FFC857] flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="bg-[#FFC857] p-2 rounded-lg text-[#2D2721]">
            ...
            <div className="flex items-center gap-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    deliveryFreeThreshold: parseFloat(e.target.value),
                  })
                }
              />
            </div>
          ...
          <div className="p-4 bg-[#F8F6F1] rounded-xl border border-[rgba(139,115,85,0.1)] space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(c) =>
                  setFormData({ ...formData, deliveryPickupAllowed: c })
                }
              />
            </div>
            ...
            {formData.deliveryPickupAllowed && (
              <div className="animate-in slide-in-from-top-2 fade-in">
                <div className="space-y-2 max-w-xs">
                  <Label className="text-[#2D2721]">Hind (EUR)</Label>
                  <Input
                    type="number"
                    min="0"
                    step="0.01"
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        deliveryPickupPrice: parseFloat(e.target.value),
                      })
                    }
                    className="bg-white"
                  />
          ...
          <div className="p-4 bg-[#F8F6F1] rounded-xl border border-[rgba(139,115,85,0.1)] space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(c) =>
                  setFormData({ ...formData, deliveryCourierAllowed: c })
                }
              />
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        deliveryCourierPrice: parseFloat(e.target.value),
                      })
                    }
                    className="bg-white"
                  />
            ...
            <div className="p-4 bg-[#F8F6F1] rounded-xl border border-[rgba(139,115,85,0.1)] space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(c) =>
                    setFormData({ ...formData, deliverySmartpostAllowed: c })
                  }
                />
              </div>
                ...
                <div className="space-y-2 animate-in fade-in">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        deliverySmartpostPrice: parseFloat(e.target.value),
                      })
                    }
                    className="bg-white"
                  />
            ...
            <div className="p-4 bg-[#F8F6F1] rounded-xl border border-[rgba(139,115,85,0.1)] space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(c) =>
                    setFormData({ ...formData, deliveryOmnivaAllowed: c })
                  }
                />
              </div>
                ...
                <div className="space-y-2 animate-in fade-in">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        deliveryOmnivaPrice: parseFloat(e.target.value),
                      })
                    }
                    className="bg-white"
                  />
        ...
        <div className="space-y-6 motion-safe:animate-fade-up">
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between p-4 bg-[#F8F6F1] rounded-xl border border-[rgba(139,115,85,0.1)]">
              <div>
                <h3 className="font-semibold text-[#2D2721] mb-1">
                  Platvormi maksed (Soovitatud)
                </h3>
                <p className="text-sm text-[#6B5744] max-w-sm">
                  Meie keskne makselahendus. Hoolitseme tagasimaksete ja
                  raportite eest.
                </p>
              </div>
              <div className="flex items-center gap-2">
                <span
                  className={`text-sm font-bold ${formData.paymentMode === "platform" ? "text-[#E17B5C]" : "text-[#8B7355]"}`}
                >
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setFormData({
                      ...formData,
                      paymentMode: checked ? "platform" : "direct",
                    })
                  }
                />
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-[#F8F6F1] rounded-xl border border-[rgba(139,115,85,0.1)]">
              <div>
                ...
                <p className="text-sm text-[#6B5744] max-w-sm">
                  Raha laekub otse sinu kontole. Vastutad ise tagasimaksete
                  eest.
                </p>
              </div>
              <div className="flex items-center gap-2">
                <span
                  className={`text-sm font-bold ${formData.paymentMode === "direct" ? "text-[#E17B5C]" : "text-[#8B7355]"}`}
                >
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setFormData({
                      ...formData,
                      paymentMode: checked ? "direct" : "platform",
                    })
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      directPaymentProvider: e.target.value,
                    })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      directPaymentApiKey: e.target.value,
                    })
                  }
