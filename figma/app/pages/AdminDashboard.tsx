...
import { MassMessaging } from "@/figma/app/components/MassMessaging";
...
import {
  RadioGroup,
  RadioGroupItem,
} from "@/figma/app/components/ui/radio-group";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@/figma/app/components/ui/select";
...
export function AdminDashboard() {
  ...
  const { chatEnabled, feedbackEnabled, setChatEnabled, setFeedbackEnabled } =
    useAdminSettings();

  // License Management State
  const [licenseModalOpen, setLicenseModalOpen] = useState(false);
  const [selectedMerchantForLicense, setSelectedMerchantForLicense] =
    useState<any>(null);
  const [extensionType, setExtensionType] = useState<"fixed" | "unlimited">(
    "fixed",
  );
  ...
  const [merchantsWithLicenses, setMerchantsWithLicenses] = useState([
    ...
    {
      id: 2,
      name: "Nordic Fashion Hub",
      country: "Finland",
      plan: "Professional",
      status: "active",
      licenseExpires: "2024-10-15",
    },
    {
      id: 3,
      name: "Riga City Deals",
      country: "Latvia",
      plan: "Professional",
      status: "active",
      licenseExpires: "2024-09-01",
    },
    {
      id: 4,
      name: "Vilnius Wellness",
      country: "Lithuania",
      plan: "Starter",
      status: "active",
      licenseExpires: "2024-08-20",
    },
    {
      id: 5,
      name: "Stockholm Beauty",
      country: "Sweden",
      plan: "Starter",
      status: "warning",
      licenseExpires: "2024-07-10",
    },
    {
      id: 6,
      name: "Oslo Tech Store",
      country: "Norway",
      plan: "Enterprise",
      status: "active",
      licenseExpires: "Unlimited",
    },
    {
      id: 7,
      name: "Tallinn Events",
  ...
  const openLicenseModal = (merchant: any) => {
    ...
    setExtensionType(
      merchant.licenseExpires === "Unlimited" ? "unlimited" : "fixed",
    );
  ...
  const globalStats = {
    ...
    totalRevenue: "EUR 2.4M",
    platformFees: "EUR 360K",
  ...
  const merchantStats = {
    ...
    avgRevenuePerMerchant: "EUR 1,928",
    totalCampaigns: 3482,
  ...
  const merchantLifecycle = [
    ...
    {
      stage: "Active Professional",
      count: 624,
      percentage: 50.0,
      color: "#E17B5C",
    },
    {
      stage: "Active Enterprise",
      count: 136,
      percentage: 10.9,
      color: "#F5C98E",
    },
  ...
  const userLifecycle = [
    ...
    {
      stage: "Engaged (31-90d)",
      count: 21850,
      percentage: 48.3,
      color: "#E17B5C",
    },
    {
      stage: "At Risk (91-180d)",
      count: 8240,
      percentage: 18.2,
      color: "#F5C98E",
    },
  ...
  const recentNewsletters = [
    ...
    {
      id: 2,
      subject: "New Features: QR Designer & More",
      sent: 43100,
      opened: 20688,
      clicked: 5346,
      date: "2024-06-08",
    ...
    {
      id: 3,
      subject: "Weekly Digest: Top Campaigns",
      sent: 42800,
      opened: 18276,
      clicked: 4908,
      date: "2024-06-01",
...
If you no longer wish to receive these emails, you can unsubscribe here.`,
  ...
  const sendNewsletter = async () => {
    ...
    setIsSending(false);
    toast.success(
      `Newsletter sent to ${totalRecipients.toLocaleString()} recipients!`,
    );
  };
  ...
  const selectedRecipientsCount = selectedSegments.reduce(
    (sum, segmentName) => {
      const segment = userSegments.find((s) => s.name === segmentName);
      return sum + (segment?.count || 0);
    },
  ...
  return (
    <div className="space-y-8 motion-safe:animate-fade-up">
      {/* Header */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 relative after:absolute after:inset-x-0 after:-bottom-3 after:h-px after:bg-gradient-to-r after:from-transparent after:via-[#E7DCC7] after:to-transparent after:content-['']">
        <div>
          <h1 className="text-4xl font-bold text-[#2D2721] mb-2">
            Platform Control Center
          </h1>
          <p className="text-lg text-[#6B5744]">
            Manage entire platform - {selectedCountry?.name || "All Countries"}
          </p>
        </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div className="text-3xl font-bold text-[#2D2721] mb-1">
                {globalStats.totalMerchants.toLocaleString()}
              </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {liveMetrics.map((metric) => (
                <div
                  key={metric.label}
                  className="flex items-center gap-4 p-4 bg-gradient-to-br from-[#FFF9ED] to-[#FFE5B4] rounded-[14px] transition-all hover:-translate-y-0.5 hover:shadow-warm"
                >
          ...
          >
            <h3 className="text-xl font-bold text-[#2D2721] mb-6">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-gradient-to-br from-[#E17B5C]/10 to-[#D16B4C]/10 rounded-[12px]">
                  ...
                  <span className="text-2xl font-bold text-[#2D2721]">
                    {globalStats.suspendedMerchants}
                  </span>
                </div>
              </div>
            </WarmCard>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-xl font-bold text-[#2D2721]">
                  Country Breakdown
                </h3>
                <p className="text-sm text-[#8B7355] mt-1">
                  Users & Merchants by Country (Active/Inactive)
                </p>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[rgba(139,115,85,0.1)]">
                    <th className="text-left py-3 px-4 text-sm font-semibold text-[#6B5744]">
                      Country
                    </th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-[#6B5744]">
                      Total Users
                ...
                <tbody>
                  {countryBreakdown.map((country) => {
                    ...
                    const merchantActiveRate = (
                      (country.activeMerchants / country.merchants) *
                      100
                    ).toFixed(1);
                      ...
                      >
                        <td className="py-4 px-4">
                          <div className="flex items-center gap-2">
                            <span className="px-2 py-1 rounded-md bg-[#FFF9ED] text-[#8B7355] text-xs font-bold">
                              {country.flag}
                            </span>
                            <span className="font-semibold text-[#2D2721]">
                              {country.country}
                        ...
                        <td className="py-4 px-4 font-bold text-[#2D2721]">
                          {country.users.toLocaleString()}
                        </td>
                        <td className="py-4 px-4">
                          <div className="flex flex-col">
                            <span className="font-semibold text-[#9DB5A5]">
                        ...
                        <td className="py-4 px-4">
                          <div className="flex flex-col">
                            <span className="font-semibold text-[#E17B5C]">
                              {country.inactiveUsers.toLocaleString()}
                            </span>
                            <span className="text-xs text-[#8B7355]">
                              {(100 - parseFloat(userActiveRate)).toFixed(1)}%
                            </span>
                          </div>
                        </td>
                        <td className="py-4 px-4 font-bold text-[#2D2721]">
                          {country.merchants.toLocaleString()}
                        </td>
                        <td className="py-4 px-4">
                          <div className="flex flex-col">
                            <span className="font-semibold text-[#9DB5A5]">
                              {country.activeMerchants.toLocaleString()}
                            </span>
                            <span className="text-xs text-[#8B7355]">
                              {merchantActiveRate}%
                            </span>
                        ...
                        <td className="py-4 px-4">
                          <div className="flex flex-col">
                            <span className="font-semibold text-[#E17B5C]">
                              {country.inactiveMerchants.toLocaleString()}
                            </span>
                            <span className="text-xs text-[#8B7355]">
                              {(100 - parseFloat(merchantActiveRate)).toFixed(
                                1,
                              )}
                              %
                            </span>
                        ...
                        <td className="py-4 px-4 font-bold text-[#FFC857]">
                          EUR {(country.revenue / 1000).toFixed(1)}K
                        </td>
                      </tr>
                    );
                  })}
                ...
                <tfoot>
                  <tr className="border-t-2 border-[rgba(139,115,85,0.2)] bg-gradient-to-br from-[#FFF9ED] to-[#FFE5B4]">
                    ...
                    <td className="py-4 px-4 font-bold text-[#9DB5A5]">
                      {countryBreakdown
                        .reduce((sum, c) => sum + c.activeUsers, 0)
                        .toLocaleString()}
                    </td>
                    <td className="py-4 px-4 font-bold text-[#E17B5C]">
                      {countryBreakdown
                        .reduce((sum, c) => sum + c.inactiveUsers, 0)
                        .toLocaleString()}
                    </td>
                    <td className="py-4 px-4 font-bold text-[#2D2721]">
                      {countryBreakdown
                        .reduce((sum, c) => sum + c.merchants, 0)
                        .toLocaleString()}
                    </td>
                    <td className="py-4 px-4 font-bold text-[#9DB5A5]">
                      {countryBreakdown
                        .reduce((sum, c) => sum + c.activeMerchants, 0)
                        .toLocaleString()}
                    </td>
                    <td className="py-4 px-4 font-bold text-[#E17B5C]">
                      {countryBreakdown
                        .reduce((sum, c) => sum + c.inactiveMerchants, 0)
                        .toLocaleString()}
                    </td>
                    <td className="py-4 px-4 font-bold text-[#FFC857]">
                      EUR{" "}
                      {(
                        countryBreakdown.reduce(
                          (sum, c) => sum + c.revenue,
                          0,
                        ) / 1000
                      ).toFixed(1)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <WarmCard hover padding="lg">
              ...
              <div className="mt-2 flex items-center gap-1 text-xs">
                ...
                <span className="text-[#9DB5A5] font-semibold">
                  +{userStats.newUsersThisMonth.toLocaleString()} this month
                </span>
              </div>
            </WarmCard>
            ...
            <WarmCard hover padding="lg">
              ...
              <div className="text-3xl font-bold text-[#2D2721] mb-1">
                {userStats.totalReferrals.toLocaleString()}
              </div>
            ...
            <WarmCard hover padding="lg">
              ...
              <div className="text-3xl font-bold text-[#2D2721] mb-1">
                {(userStats.totalPointsIssued / 1000000).toFixed(1)}M
              </div>
          ...
          <WarmCard padding="lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {engagementMetrics.map((metric) => (
                <div
                  key={metric.metric}
                  className="flex items-center gap-4 p-4 bg-gradient-to-br from-[#FFF9ED] to-[#FFE5B4] rounded-[14px]"
                >
                  <metric.icon className={`h-8 w-8 ${metric.color}`} />
                  <div>
                    <div className="text-2xl font-bold text-[#2D2721]">
                    ...
                    <div className="text-xs text-[#9DB5A5] font-semibold mt-1">
                      {metric.trend}
                    </div>
                  </div>
                </div>
                  ...
                  <div key={channel.channel}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          className={`text-sm font-semibold ${channel.growth.startsWith("+") ? "text-[#9DB5A5]" : "text-[#E17B5C]"}`}
                        >
                          {channel.growth}
                        </span>
                      </div>
                ...
                <tbody>
                  {topUsers.map((user, idx) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-4 font-semibold text-[#9DB5A5]">
                        {user.referrals}
                      </td>
                      <td className="py-4 px-4 font-bold text-[#2D2721]">
                        {user.earnings}
                      </td>
                      <td className="py-4 px-4 text-[#6B5744]">
            ...
            <WarmCard padding="lg">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-[#9DB5A5]/10 to-[#7FA090]/10 rounded-[12px]">
                  ...
                  <div>
                    <div className="font-semibold text-[#2D2721] mb-1">
                      Strong Referral Growth
                    </div>
                    <div className="text-sm text-[#6B5744]">
                      Referral signups increased by 24.1% this month, the
                      highest channel growth.
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-[#FFC857]/10 to-[#FFB627]/10 rounded-[12px]">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-[#6B5744]">
                      93.5% of users are active in the last 30 days, exceeding
                      industry benchmarks.
                    </div>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-[#E17B5C]/10 to-[#D16B4C]/10 rounded-[12px]">
                  ...
                  <div>
                    <div className="font-semibold text-[#2D2721] mb-1">
                      Top Markets: Nordics & Baltics
                    </div>
                    <div className="text-sm text-[#6B5744]">
                      Finland, Estonia, and Lithuania account for 54% of all
                      active users.
                    </div>
                  </div>
                </div>
            ...
            <WarmCard padding="lg">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-4 bg-[#FFF3E0] border border-[#E17B5C] rounded-[12px]">
                  ...
                  <div>
                    <div className="font-semibold text-[#2D2721] text-sm mb-1">
                      4,590 Dormant Users (180d+)
                    </div>
                    <div className="text-xs text-[#6B5744] mb-2">
                      Launch re-engagement campaign with special offers.
                    </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-[#E3F2FD] border border-[#9DB5A5] rounded-[12px]">
                  ...
                  <div>
                    <div className="font-semibold text-[#2D2721] text-sm mb-1">
                      2,180 New Users This Week
                    </div>
                    <div className="text-xs text-[#6B5744] mb-2">
                      Send welcome series to improve activation rate.
                    </div>
                    <WarmButton size="sm" variant="outline">
                      Send Welcome
                    </WarmButton>
                ...
                <div className="flex items-start gap-3 p-4 bg-[#FFF9ED] border border-[#FFC857] rounded-[12px]">
                  ...
                  <div>
                    <div className="font-semibold text-[#2D2721] text-sm mb-1">
                      Low Activation in New Markets
                    </div>
                    <div className="text-xs text-[#6B5744] mb-2">
                      Germany, France, Spain at 70% activation vs 85% target.
                    </div>
                    <WarmButton size="sm" variant="outline">
                      View Details
                    </WarmButton>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <WarmCard hover padding="lg">
              ...
              <div className="text-3xl font-bold text-[#2D2721] mb-1">
                {merchantStats.totalMerchants.toLocaleString()}
              </div>
              <div className="text-sm text-[#8B7355]">Total Merchants</div>
              <div className="mt-2 flex items-center gap-1 text-xs">
                <TrendingUp className="h-3 w-3 text-[#9DB5A5]" />
                <span className="text-[#9DB5A5] font-semibold">
                  +{merchantStats.newMerchantsThisMonth} this month
                </span>
              </div>
            </WarmCard>
            ...
            <WarmCard hover padding="lg">
              ...
              <div className="text-3xl font-bold text-[#2D2721] mb-1">
                {merchantStats.activeMerchants.toLocaleString()}
              </div>
              <div className="text-sm text-[#8B7355]">Active Merchants</div>
              <div className="mt-2">
                <Progress
                  value={
                    (merchantStats.activeMerchants /
            ...
            <WarmCard hover padding="lg">
              ...
              <div className="text-3xl font-bold text-[#2D2721] mb-1">
                {merchantStats.avgRevenuePerMerchant}
              </div>
              <div className="text-sm text-[#8B7355]">
                Avg Revenue / Merchant
              </div>
              <div className="mt-2 text-xs text-[#6B5744]">
                Platform MRR: EUR 360K
              </div>
            </WarmCard>
            ...
            <WarmCard hover padding="lg">
              ...
              <div className="text-3xl font-bold text-[#2D2721] mb-1">
                {merchantStats.totalCampaigns.toLocaleString()}
              </div>
            ...
            <WarmCard padding="lg">
              ...
              <div className="space-y-3">
                {pendingMerchants.map((merchant) => (
                  <div
                    key={merchant.id}
                    className="flex items-center justify-between p-4 bg-gradient-to-br from-[#FFF9ED] to-[#FFE5B4] rounded-[14px] border border-[rgba(139,115,85,0.1)]"
                  >
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-[#8B7355]">
                        ...
                        <span
                          className={
                            merchant.documents === "Complete"
                              ? "text-[#9DB5A5] font-semibold"
                              : "text-[#E17B5C] font-semibold"
                          }
                        >
                          {merchant.documents}
                        </span>
          ...
          <WarmCard padding="lg">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-[#8B7355] mt-1">
                  Monitor and extend merchant licenses
                </p>
              </div>
              <div className="flex gap-2">
                <Input
                  className="h-9 w-[200px] bg-white border-[rgba(139,115,85,0.2)]"
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[rgba(139,115,85,0.1)]">
                    ...
                    <th className="text-right py-3 px-4 text-sm font-semibold text-[#6B5744]">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {merchantsWithLicenses.map((merchant) => (
                    <tr
                      ...
                      className="border-b border-[rgba(139,115,85,0.05)] hover:bg-[#FFF9ED] transition-colors"
                    >
                      <td className="py-4 px-4 font-semibold text-[#2D2721]">
                        {merchant.name}
                      </td>
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`px-2 py-1 rounded text-xs font-medium ${
                            merchant.plan === "Enterprise"
                              ? "bg-[#E17B5C]/10 text-[#E17B5C]"
                              : merchant.plan === "Professional"
                                ? "bg-[#FFC857]/10 text-[#B58D3F]"
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-1.5">
                          ...
                          />
                          <span className="text-sm capitalize text-[#6B5744]">
                            {merchant.status}
                          </span>
                        </div>
                      </td>
                      ...
                      <td className="py-4 px-4 text-right">
                        <WarmButton
                          size="sm"
                          variant="outline"
                          onClick={() => openLicenseModal(merchant)}
                        >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-sm text-[#2D2721]">
                  ...
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        setNewsletterForm({
                          ...newsletterForm,
                          includeOffers: e.target.checked,
                        })
                      }
                      className="w-4 h-4 rounded border-[rgba(139,115,85,0.2)]"
                    />
            ...
            <WarmCard padding="lg">
              ...
              {generatedContent.subject ? (
                  ...
                  <div className="pt-4 border-t border-[rgba(139,115,85,0.1)]">
                    ...
                    <div className="space-y-2 mb-4">
                      {userSegments.map((segment) => (
                        <label
                          key={segment.name}
                          className="flex items-center justify-between p-3 bg-[#FFF9ED] rounded-[12px] cursor-pointer hover:bg-[#FFE5B4] transition-colors"
                        >
                          <div className="flex items-center gap-2">
                            <input
                              type="checkbox"
                              ...
                              className="w-4 h-4 rounded border-[rgba(139,115,85,0.2)]"
                            />
                            <span className="text-sm font-medium text-[#2D2721]">
                              {segment.name}
                            </span>
                          </div>
                    ...
                    >
                      ...
                      Send to {selectedRecipientsCount.toLocaleString()}{" "}
                      Recipients
                    </WarmButton>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-sm text-[#A89985]">
          ...
          <WarmCard padding="lg">
            ...
            <div className="space-y-3">
              {recentNewsletters.map((newsletter) => (
                <div
                  key={newsletter.id}
                  className="flex items-center justify-between p-4 bg-gradient-to-br from-[#FFF9ED] to-[#FFE5B4] rounded-[14px]"
                >
                  <div className="flex-1">
                    <div className="font-semibold text-[#2D2721] mb-1">
                      {newsletter.subject}
                    ...
                    <div className="flex items-center gap-4 text-sm text-[#8B7355]">
                      ...
                      <span>
                        Opened: {newsletter.opened.toLocaleString()} (
                        {((newsletter.opened / newsletter.sent) * 100).toFixed(
                          1,
                        )}
                        %)
                      </span>
                      <span>
                        Clicked: {newsletter.clicked.toLocaleString()}
                      </span>
      ...
      {activeTab === "payments" && (
        <>
          ...
          <WarmCard padding="lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-gradient-to-br from-[#9DB5A5]/10 to-[#7FA090]/10 rounded-[16px] border border-[#9DB5A5]/30">
                ...
                <div className="text-lg font-semibold text-[#FFC857]">
                  EUR 9,253/mo
                </div>
              </div>
          ...
          <WarmCard
            padding="lg"
            className="bg-[#FFF3E0] border border-[#E17B5C]"
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-[#2D2721] mb-2">
                  Failed Payments Requiring Attention
                </h3>
                <p className="text-sm text-[#6B5744] mb-4">
                  7 merchants have failed payments in the last 7 days. Follow up
                  to prevent subscription cancellation.
                </p>
                <WarmButton variant="outline" size="sm">
        ...
        <>
          <WarmCard padding="xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-[#2D2721]">
                  Widget Management
                </h2>
                <p className="text-[#6B5744] mt-1">
                  Control live chat and feedback widgets across the platform
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 bg-[#FFF9ED] rounded-[16px] border border-[rgba(139,115,85,0.1)]">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#2D2721] text-lg">
                        Live Chat Widget
                      </h3>
                  ...
                  {chatEnabled ? (
                    <div className="flex items-center gap-2 text-[#9DB5A5]">
                      ...
                      <span className="font-medium">
                        Active - Users can see the chat button in bottom left
                      </span>
                    </div>
                  ) : (
                    <div className="flex items-center gap-2 text-[#8B7355]">
                      ...
                      <span>
                        Disabled - Chat widget is hidden from all users
                      </span>
                    </div>
                  )}
                </div>
                <div className="p-4 bg-white rounded-[12px] border border-[rgba(139,115,85,0.1)]">
                  <div className="text-xs font-semibold text-[#8B7355] mb-2">
                    Features:
                  </div>
                ...
                <div className="text-sm text-[#6B5744] mb-3">
                  {feedbackEnabled ? (
                    <div className="flex items-center gap-2 text-[#FFC857]">
                      <CheckCircle2 className="h-4 w-4" />
                      <span className="font-medium">
                        Active - Users can submit feedback and ratings
                      </span>
                    </div>
                  ) : (
                    <div className="flex items-center gap-2 text-[#8B7355]">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-[#6B5744] space-y-2">
                      <li>
                        {" "}
                        Enable chat during business hours for immediate support
                      </li>
                      <li>
                        {" "}
                        Enable feedback after major feature launches to gather
                        insights
                      </li>
                      <li>
                        {" "}
                        Both widgets respect user privacy - they disappear after
                        interaction
                      </li>
                      <li>
                        {" "}
                        Widgets only appear when enabled here - full admin
                        control
                      </li>
                    </ul>
                  </div>
              ...
              <div className="p-6 bg-white rounded-[16px] border-2 border-dashed border-[rgba(139,115,85,0.2)]">
                <h3 className="font-semibold text-[#2D2721] mb-3">
                  Widget Preview
                </h3>
                <div className="text-sm text-[#6B5744] mb-4">
                  {chatEnabled || feedbackEnabled ? (
                    <>
                      Check the <strong>bottom left corner</strong> of your
                      screen to see active widgets!
                    </>
                  ) : (
        ...
        <DialogContent className="sm:max-w-[425px] bg-[#FFF9ED] border-[#E5D5C5]">
          <DialogHeader>
            ...
            <DialogDescription className="text-[#6B5744]">
              Update license duration for{" "}
              <strong>{selectedMerchantForLicense?.name}</strong>.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="space-y-4">
              ...
              <RadioGroup
                value={extensionType}
                onValueChange={(v: "fixed" | "unlimited") =>
                  setExtensionType(v)
                }
            ...
            {extensionType === "fixed" && (
              <div className="space-y-2 animate-in fade-in zoom-in-95 duration-200">
                <Label htmlFor="duration" className="text-[#2D2721]">
                  Duration (Months)
                </Label>
                <Select
                  value={extensionDuration}
                  onValueChange={setExtensionDuration}
                >
                  <SelectTrigger
                    id="duration"
                    className="bg-white border-[rgba(139,115,85,0.2)]"
                  >
          ...
          <DialogFooter>
            ...
            <WarmButton
              onClick={saveLicenseExtension}
              className="bg-[#2D2721] text-white hover:bg-[#3E362E]"
            >
              Save Changes
            </WarmButton>
          </DialogFooter>
