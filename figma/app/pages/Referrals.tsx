...
export function Referrals() {
  ...
  return (
    <div className="space-y-6 motion-safe:animate-fade-up">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-[#6B5744] mt-1">
            Invite merchants and earn rewards
          </p>
        </div>
      ...
      <WarmCard padding="none" className="overflow-hidden">
        <div className="bg-gradient-to-br from-[#FFF9ED] to-[#FFE5B4] p-8">
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            {/* Referral Link */}
            <div>
              <label className="text-sm font-medium text-[#6B5744] mb-2 block">
                Your Referral Link
              </label>
        ...
        <WarmCard padding="lg" className="text-center">
          ...
          <div className="w-64 h-64 mx-auto bg-white rounded-xl p-4 shadow-warm flex items-center justify-center border border-[rgba(139,115,85,0.1)]">
            <div className="text-center">
              ...
              <p className="text-xs text-[#8B7355] mt-1 font-mono">
                {referralData.code}
              </p>
            </div>
          </div>
      ...
      <WarmCard
        padding="lg"
        className="bg-gradient-to-br from-[#FFF9ED] to-[#FFE5B4]"
      >
        <h3 className="text-lg font-semibold text-[#2D2721] mb-4">
          How Referrals Work
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-[#2D2721] mb-1">
                Share Your Link
              </h4>
              <p className="text-sm text-[#6B5744]">
                Send your referral link or code to other merchants
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
      ...
      <WarmCard padding="lg">
        <div className="mb-6">
          ...
          <p className="text-sm text-[#6B5744]">
            Track all merchants you've referred
          </p>
        </div>
            ...
            <tbody>
              {referrals.map((referral) => (
                ...
                >
                  ...
                  <td className="py-4 px-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${getStatusColor(referral.status)}`}
                    >
