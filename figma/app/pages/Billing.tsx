...
export function Billing() {
  ...
  const handleChangePlan = (planId: string) => {
    toast.success(
      `Pakett vahetatud: ${plans.find((p) => p.id === planId)?.name}`,
    );
  };
  ...
  return (
    <div className="space-y-6 motion-safe:animate-fade-up pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[#2D2721]">
            Finantsid ja Arved
          </h1>
          <p className="text-[#6B5744] mt-1">
            Halda oma tellimust, makseviise ja ettevõtte andmeid
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <WarmCard padding="lg" className="relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8 relative z-10">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span
                    className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${statusConfig.color}`}
                  >
              ...
              <div className="text-right">
                <div className="text-4xl font-bold text-[#2D2721] flex items-baseline justify-end gap-1">
                  <CurrencyDisplay amount={currentPlan.price} currency="EUR" />
                  <span className="text-lg text-[#8B7355] font-normal">
                    /kuu
                  </span>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              <div className="bg-white/50 p-4 rounded-xl border border-[#E7DCC7]">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs font-bold text-[#2D2721]">
                    4,250 / 10,000
                  </span>
                </div>
            ...
            <div className="flex flex-wrap gap-3 pt-6 border-t border-[#E7DCC7]/50">
              ...
              <WarmButton
                variant="ghost"
                className="text-[#E17B5C] hover:text-[#C56041] hover:bg-[#FFF9ED]"
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <WarmButton variant="ghost" size="sm" className="text-[#8B7355]">
                Vaata kõiki
              </WarmButton>
            </div>
        ...
        <div className="space-y-6 motion-safe:animate-fade-up">
            ...
            {isEditingBilling ? (
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="text-[#6B5744] flex items-center gap-2">
                  <span className="w-4 flex justify-center opacity-50">#</span>{" "}
                  {billingDetails.vatNumber}
                </div>
                <div className="text-[#6B5744] flex items-center gap-2">
                  <span className="w-4 flex justify-center opacity-50">
          ...
          <div className="bg-[#2D2721] rounded-2xl p-6 text-[#E7DCC7] relative overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-white mb-2 relative z-10">
              Vajad rohkem võimsust?
            </h3>
            <p className="text-sm opacity-80 mb-6 relative z-10">
              Enterprise pakett pakub piiramatut mahtu ja personaalset haldurit.
            </p>
            ...
            <div className="space-y-3 mb-6 relative z-10">
              ...
              <div className="flex items-center gap-2 text-sm">
                <Check className="w-4 h-4 text-[#00D098]" /> White-label
                lahendus
              </div>
              <div className="flex items-center gap-2 text-sm">
      ...
      <div className="pt-8 border-t border-[#E7DCC7]">
        <h2 className="text-2xl font-bold text-[#2D2721] mb-6 text-center">
          Kõik Paketid
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {plans.map((plan) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-[#2D2721] mb-2 text-center">
                {plan.name}
              </h3>
              ...
              <ul className="space-y-4 mb-8">
                {plan.features.map((feature, idx) => (
                  <li key={idx} className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-[#6B5744] font-medium">
                      {feature}
                    </span>
                  </li>
                ))}
