...
function DashboardHome({
  ...
  const tasks = [
    {
      id: 1,
      text: "3 uut tellimust vajavad pakkimist",
      type: "urgent",
      action: "orders",
    },
    {
      id: 2,
      text: "Madal laoseis: Sony akud (2tk)",
      type: "warning",
      action: "warehouse",
    },
    {
      id: 3,
      text: "2 e-kirja ootavad vastust",
      type: "info",
  ...
  return (
    <div className="space-y-8 max-w-[1600px] mx-auto pb-10 motion-safe:animate-fade-up">
      {/* Welcome & Focus Section */}
      <div
        className="flex flex-col md:flex-row gap-8 items-start justify-between motion-safe:animate-fade-up"
        style={{ animationDelay: "40ms" }}
      >
        <div className="space-y-2">
          <h1 className="text-3xl font-bold text-[#2D2721] tracking-tight">
            Tere hommikust, Kaupmees!
          </h1>
          <p className="text-[#6B5744] text-lg font-medium">
            Sul on täna{" "}
            <span className="text-[#E17B5C] font-bold">
              3 kriitilist tegevust
            </span>{" "}
            ja 4 logistilist liikumist.
          </p>
        </div>

        {/* Quick Actions Widget */}
        <div className="flex gap-3 bg-white p-2 rounded-2xl shadow-sm border border-[#E7DCC7] hover:shadow-warm transition-all">
          <button
            onClick={() => navigate("/orders/create")}
            className="flex flex-col items-center justify-center w-20 h-20 rounded-xl hover:bg-[#FFF9ED] hover:text-[#FFC857] transition-all group gap-1"
          >
            ...
            <span className="text-[10px] font-bold text-[#6B5744] group-hover:text-[#E17B5C]">
              Uus tellimus
            </span>
          </button>
          <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <WarmCard
          padding="lg"
          className="bg-white border-b-4 border-b-[#FFC857] shadow-sm hover:shadow-warm-lg hover:-translate-y-1 transition-all cursor-pointer relative overflow-hidden"
          style={{ animationDelay: "80ms" }}
        >
          <div className="flex justify-between items-start mb-2">
            <div className="text-sm font-bold text-[#8B7355] uppercase tracking-wide">
              Müügitulu (Kuu)
            </div>
          ...
          <div className="text-xs font-medium text-[#00D098] bg-[#E6F4EA] inline-block px-2 py-0.5 rounded-full">
            +15.3% vs eelmine
          </div>
        </WarmCard>
        ...
        <WarmCard
          padding="lg"
          className="bg-[#2D2721] text-[#FAF7F2] border-b-4 border-b-[#E17B5C] shadow-md hover:shadow-warm-lg hover:-translate-y-1 transition-all cursor-pointer relative overflow-hidden"
          onClick={() => setActivePage("orders")}
          style={{ animationDelay: "140ms" }}
        >
          <div className="flex justify-between items-start mb-2">
            <div className="text-sm font-bold text-[#E7DCC7]/70 uppercase tracking-wide">
              Aktiivsed Rendid
            </div>
            <Camera className="w-4 h-4 text-[#E17B5C]" />
          </div>
          <div className="text-3xl font-bold text-white mb-1">8</div>
          <div className="text-xs font-medium text-[#E17B5C] bg-[#3E352F] inline-block px-2 py-0.5 rounded-full">
            2 hilinenud
          </div>
        </WarmCard>
        ...
        <WarmCard
          padding="lg"
          className="bg-white border-b-4 border-b-[#00D098] shadow-sm hover:shadow-warm-lg hover:-translate-y-1 transition-all cursor-pointer relative overflow-hidden"
          onClick={() => setActivePage("orders")}
        ...
        >
          ...
          <div className="text-xs font-medium text-[#8B7355]">
            Vajavad tähelepanu
          </div>
        </WarmCard>
        ...
        <WarmCard
          padding="lg"
          className="bg-white border-b-4 border-b-[#E17B5C] shadow-sm hover:shadow-warm-lg hover:-translate-y-1 transition-all cursor-pointer relative overflow-hidden"
        ...
        >
          ...
          <div className="text-xs font-medium text-[#E17B5C]">
            Toodet otsakorral
          </div>
        </WarmCard>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start h-full">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <WarmCard
            padding="none"
            className="bg-white border border-[#E7DCC7] overflow-hidden"
          ...
          >
            <div className="p-4 border-b border-[#E7DCC7] bg-[#FFF9ED] flex justify-between items-center">
              ...
              <span className="text-xs font-bold bg-[#E17B5C] text-white px-2 py-1 rounded-full">
                3 tegevust
              </span>
            </div>
            <div className="divide-y divide-[#E7DCC7]">
              {tasks.map((task) => (
                <div
                  key={task.id}
                  className="p-4 flex items-center justify-between hover:bg-[#FAF7F2] transition-colors group cursor-pointer border-l-4 border-l-transparent hover:border-l-[#FFC857]"
                  onClick={() => setActivePage(task.action)}
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-2 h-2 rounded-full ${task.type === "urgent" ? "bg-[#E17B5C]" : task.type === "warning" ? "bg-[#FFC857]" : "bg-[#00D098]"}`}
                    ></div>
                    <span
                      className={`font-medium text-[#2D2721] ${task.type === "urgent" ? "font-bold" : ""}`}
                    >
                      {task.text}
                    </span>
                  </div>
          ...
          <WarmCard
            padding="lg"
            className="bg-white border border-[#E7DCC7] h-[400px] flex flex-col"
        ...
        <div className="space-y-8">
          ...
          <WarmCard
            padding="lg"
            className="bg-white border border-[#E7DCC7]"
            ...
            <div className="space-y-6">
              ...
              <div>
                <h4 className="text-xs font-bold text-[#8B7355] uppercase mb-3 flex justify-between">
                  ...
                  <span className="text-[#2D2721]">
                    {todayLogistics.goingOut.length}
                  </span>
                </h4>
                <div className="space-y-3">
                  {todayLogistics.goingOut.map((item) => (
                    <div
                      key={item.id}
                      className="flex items-start gap-3 p-3 bg-[#FAF7F2] rounded-xl border border-[#E7DCC7]/50 hover:shadow-warm transition-shadow"
                    >
                      <div className="bg-white p-2 rounded-lg text-[#FFC857] shadow-sm">
                        <Box className="w-4 h-4" />
                      </div>
                      <div>
                        <div className="font-bold text-[#2D2721] text-sm">
                          {item.item}
                        </div>
              ...
              <div>
                <h4 className="text-xs font-bold text-[#8B7355] uppercase mb-3 flex justify-between">
                  Tagastamisel{" "}
                  <span className="text-[#2D2721]">
                    {todayLogistics.returning.length}
                  </span>
                </h4>
                <div className="space-y-3">
                  {todayLogistics.returning.map((item) => (
                    <div
                      key={item.id}
                      className={`flex items-start gap-3 p-3 rounded-xl border transition-shadow ${item.status === "late" ? "bg-[#FFF9ED] border-[#E17B5C]/30" : "bg-[#FAF7F2] border-[#E7DCC7]/50"}`}
                    >
                      <div
                        className={`bg-white p-2 rounded-lg shadow-sm ${item.status === "late" ? "text-[#E17B5C]" : "text-[#00D098]"}`}
                      >
                        {item.status === "late" ? (
                      ...
                      <div>
                        ...
                        {item.status === "late" && (
                          <div className="text-[10px] font-bold text-[#E17B5C] mt-1">
                            HILINENUD
                          </div>
                        )}
                      </div>
          ...
          <WarmCard
            padding="lg"
            className="bg-[#2D2721] text-[#E7DCC7]"
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-bold text-[#FFC857]">
                  12 renti
                </span>
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <span className="text-xs font-bold text-[#E17B5C]">
                  8 renti
                </span>
              </div>
              <div className="w-full bg-[#3E352F] h-1.5 rounded-full overflow-hidden">
...
export function MerchantDashboard() {
  ...
  const renderContent = () => {
    switch (activePage) {
        ...
        return (
          <div className="space-y-8 motion-safe:animate-fade-up">
            ...
            <div className="bg-white p-6 rounded-xl border border-[#E7DCC7]">
              <h3 className="text-xl font-bold mb-4 text-[#2D2721]">
                Domeeni seadistus
              </h3>
              <DomainSettings />
            </div>
      ...
      default:
        return <div>Lehte ei leitud</div>;
    }
  };
        ...
        <div className="h-24 flex items-center px-6 border-b border-[#3E352F]/50">
          <div className="font-bold text-white text-xl flex items-center gap-4 w-full">
            ...
            <div className="flex-1 min-w-0">
              <div className="leading-tight truncate text-lg tracking-tight">
                Minu Pood
              </div>
              <div className="text-[10px] text-[#8B7355] font-semibold mt-1 uppercase tracking-widest truncate">
                Kaupmehe Portaal
              </div>
            </div>
          </div>
          ...
          {navItems.map((item: any, idx) => {
            if (item.type === "divider") {
              return (
                <div
                  key={idx}
                  className="px-3 py-3 mt-6 mb-1 text-[10px] font-extrabold uppercase tracking-[0.2em] text-[#6B5744]/60 select-none"
                >
                  {item.label}
                </div>
              );
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3.5 relative z-10">
                  <Icon
                    className={`w-5 h-5 transition-colors ${isActive ? "text-[#2D2721]" : "text-[#6B5744] group-hover:text-white"}`}
                  />
                  {item.label}
                </div>
                {item.badge && (
                  <span
                    className={`text-[10px] px-2 py-0.5 rounded-full font-bold shadow-sm relative z-10 ${isActive ? "bg-[#2D2721] text-[#FFC857]" : "bg-[#E17B5C] text-white"}`}
                  >
                    {item.badge}
                  </span>
                )}
        ...
        <div className="p-4 border-t border-[#3E352F]/50 bg-[#161311]">
          <div className="flex items-center gap-3 mb-4 p-3 rounded-xl bg-[#25201B] border border-[#3E352F] hover:border-[#6B5744]/50 cursor-pointer transition-all group">
            ...
            <div className="overflow-hidden">
              <div className="text-white text-sm font-bold truncate group-hover:text-[#FFC857] transition-colors">
                Minu Pood OÜ
              </div>
              <div className="text-xs text-[#8B7355] group-hover:text-[#9DB5A5] transition-colors">
                Pro Pakett
              </div>
            </div>
          </div>
          <button
            onClick={() => navigate("/")}
            className="w-full flex items-center justify-center gap-2 text-xs font-bold text-[#8B7355] hover:text-[#E17B5C] hover:bg-[#3E352F]/30 transition-all py-2.5 rounded-lg uppercase tracking-wide"
          >
        ...
        <header className="h-20 flex items-center justify-between px-8 z-10 sticky top-0 bg-[#FAF7F2]/80 backdrop-blur-xl border-b border-[#E7DCC7]/30 shadow-sm">
          <div className="flex items-center gap-4">
            <div className="flex flex-col justify-center">
              <h2 className="font-extrabold text-2xl text-[#2D2721] tracking-tight leading-none mb-0.5">
                {navItems.find((n: any) => n.id === activePage)?.label ||
                  "Töölaud"}
              </h2>
          ...
          <div className="flex items-center gap-4">
            ...
            <WarmButton
              size="sm"
              variant="outline"
              className="hidden sm:flex bg-white hover:bg-[#FFF9ED] border-[#E7DCC7] hover:border-[#FFC857] shadow-sm font-bold text-[#6B5744]"
