...
const FloatingParticle = ({ delay = 0, duration = 3, size = 8 }: { delay?: number; duration?: number; size?: number }) => (
  <motion.div
...
export function UserDashboard() {
  ...
  const leaderboard = [
    ...
    { rank: 48, name: 'You (Maria Silva)', points: 2450, avatar: '👩', badge: '⭐', isUser: true },
  ];

  // Achievements/Badges
  const achievements = [
    { id: 1, name: 'First Share', icon: '🎯', unlocked: true, color: 'from-[#9DB5A5] to-[#7FA090]' },
    { id: 2, name: '10 Referrals', icon: '🚀', unlocked: true, color: 'from-[#FFC857] to-[#FFB627]' },
    { id: 3, name: 'Week Streak', icon: '🔥', unlocked: true, color: 'from-[#E17B5C] to-[#D16B4C]' },
    { id: 4, name: '1000 Points', icon: '💎', unlocked: false, color: 'from-gray-300 to-gray-400' },
  ];

  // Recent activities
  const recentActivities = [
    { id: 1, type: 'share', platform: 'Facebook', points: 50, time: '2 hours ago' },
    { id: 2, type: 'referral', name: 'João Costa', points: 200, time: '1 day ago' },
    { id: 3, type: 'share', platform: 'Instagram', points: 50, time: '2 days ago' },
    { id: 4, type: 'bonus', reason: 'Weekly Streak', points: 100, time: '3 days ago' },
    { id: 5, type: 'share', platform: 'WhatsApp', points: 50, time: '4 days ago' },
  ];

  // Available rewards
  const availableRewards = [
    { id: 1, name: '€10 Voucher', points: 1000, image: '🎁', available: true, discount: '25% OFF' },
    { id: 2, name: '€25 Voucher', points: 2500, image: '💎', available: false },
    { id: 3, name: '€50 Voucher', points: 5000, image: '🏆', available: false },
    { id: 4, name: 'Premium Month', points: 3000, image: '⭐', available: false },
  ];
  ...
  // My Active Vouchers
  const myVouchers = [
    { id: 1, merchant: 'Fashion Store', title: '€20 Off Purchase', code: 'FASH20', expiresIn: '5 days', emoji: '👗', used: false },
    { id: 2, merchant: 'Coffee House', title: 'Free Coffee', code: 'COFFEE', expiresIn: '2 days', emoji: '☕', used: false },
    { id: 3, merchant: 'Tech Store', title: '10% Off Electronics', code: 'TECH10', expiresIn: '12 days', emoji: '💻', used: true },
  ];

  // My Gift Cards
  const myGiftCards = [
    { id: 1, merchant: 'Universal Gift Card', value: '€50', balance: '€35', emoji: '🎁', color: 'from-[#FFC857] to-[#FFB627]' },
    { id: 2, merchant: 'Spa & Wellness', value: '€100', balance: '€100', emoji: '💆', color: 'from-[#D8A7C5] to-[#C897B5]' },
  ];

  // My Event Tickets
  const myTickets = [
    { id: 1, event: 'Summer Fashion Show', date: 'Feb 15, 2026', location: 'Tallinn', quantity: 2, emoji: '🎭', qrCode: true },
    { id: 2, event: 'Food Festival', date: 'Feb 22, 2026', location: 'Riga', quantity: 1, emoji: '🍽️', qrCode: true },
  ];

  // Quick Actions
  const quickActions = [
    { name: 'Browse Vouchers', icon: Tag, color: 'from-[#FFC857] to-[#FFB627]', route: '/vouchers' },
    { name: 'Active Campaigns', icon: TrendingUp, color: 'from-[#9DB5A5] to-[#7FA090]', route: '/campaigns' },
    { name: 'Buy Gift Cards', icon: CreditCard, color: 'from-[#E17B5C] to-[#D16B4C]', route: '/gift-cards' },
    { name: 'Book Events', icon: Calendar, color: 'from-[#D8A7C5] to-[#C897B5]', route: '/events' },
  ];
  ...
  const progressPercentage = (userStats.totalPoints / userStats.nextRewardAt) * 100;
  ...
  return (
    ...
    >
      <SEOHead
        ...
        keywords={['rewards', 'points', 'referrals', 'bonuses', 'vouchers', 'gift cards', 'campaigns', 'preemiad', 'boonused', 'soovitused']}
        type="website"
      />
      
      {/* Floating Background Particles */}
      {[...Array(15)].map((_, i) => (
        <FloatingParticle key={i} delay={i * 0.3} duration={3 + Math.random() * 2} size={6 + Math.random() * 8} />
      ))}
      ...
      >
        <div className="text-center lg:text-left">
          ...
          >
            Welcome back, <span className="font-bold text-[#FFC857]">{userName}</span>! 
            <motion.span
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2">
          <WarmCard hover padding="lg" className="relative overflow-hidden bg-gradient-to-br from-white via-[#FFF9ED] to-[#FFE5B4] h-full">
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  >
                    <AnimatedCounter value={userStats.totalPoints} duration={1.5} />
                  </motion.div>
                  <motion.div 
        ...
        <div className="space-y-4">
          <motion.div variants={itemVariants}>
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <WarmCard hover padding="lg" className="text-center bg-gradient-to-br from-white via-[#E8F4EC] to-[#D0E8DD] cursor-pointer relative overflow-hidden">
                <motion.div
                ...
                <div className="text-sm text-[#8B7355] font-semibold">Successful Referrals</div>
              </WarmCard>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <WarmCard hover padding="lg" className="text-center bg-gradient-to-br from-white via-[#FFE5E5] to-[#FFD5D5] cursor-pointer relative overflow-hidden">
                <motion.div
                ...
                <div className="text-sm text-[#8B7355] font-semibold">Total Earned</div>
              </WarmCard>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <WarmCard hover padding="lg" className="text-center bg-gradient-to-br from-white via-[#FFF3E0] to-[#FFE0B2] cursor-pointer relative overflow-hidden">
                <motion.div
      ...
      <motion.div variants={itemVariants}>
        <WarmCard padding="lg" className="bg-gradient-to-br from-[#F8F6F1] via-white to-[#FFF9ED] relative overflow-hidden">
          <motion.div
          ...
          <div className="flex items-center gap-3 mb-6 relative z-10">
            ...
            <div>
              <h3 className="text-xl font-semibold text-[#2D2721]">🏅 Your Achievements</h3>
              <p className="text-sm text-[#8B7355]">Unlock badges by completing challenges</p>
            </div>
          </div>
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className="text-xs font-semibold text-[#2D2721] relative z-10">{achievement.name}</div>
                  {achievement.unlocked && (
                    <motion.div
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
      ...
      <motion.div variants={itemVariants}>
        <WarmCard padding="lg" className="bg-gradient-to-br from-[#FFF9ED] via-[#FFE5B4] to-[#FFF9ED] border-2 border-[rgba(255,200,87,0.4)] relative overflow-hidden">
          <motion.div
