...
const CAMPAIGNS_DATA = [
  ...
  { id: 3, name: 'Sõbrapäeva Pakkumine', type: 'social', status: 'scheduled', reach: 0, clicks: 0, sales: 0, progress: 0, budget: 2000, spent: 0 },
  { id: 4, name: 'Püsikliendi Kampaania', type: 'email', status: 'active', reach: 3200, clicks: 120, sales: 980, progress: 30, budget: 300, spent: 90 },
];
...
export function CampaignsList() {
  ...
  const handleStatusToggle = (id: number, currentStatus: string) => {
    ...
    toast.success(`Kampaania ${newStatus === 'active' ? 'jätkatud' : 'peatatud'}`);
  };
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
           ...
           <p className="text-[#6B5744] mt-1">Halda reklaame, uudiskirju ja sooduspakkumisi ühest kohast</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
         ...
         <WarmCard padding="md" className="col-span-1">
            ...
            <div className="text-2xl font-bold text-[#2D2721] mb-1">
               {campaigns.reduce((acc, c) => acc + c.sales, 0).toLocaleString()}€
            </div>
         </WarmCard>
      </div>
            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
               ...
               <div className="flex gap-2">
                  {['all', 'active', 'scheduled', 'completed'].map(status => (
                     ...
                     >
                        {status === 'all' ? 'Kõik' : status === 'active' ? 'Aktiivsed' : status === 'scheduled' ? 'Ootel' : 'Lõppenud'}
                     </button>
                  ))}
               </div>
            </div>
                  ...
                  <WarmCard key={c.id} padding="none" className="bg-white group hover:shadow-lg transition-all border border-[#E7DCC7] overflow-hidden">
                     <div className="p-5">
                           ...
                           <div className="flex items-center gap-4">
                              ...
                              <div>
                                 ...
                                 <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider mt-1">
                                    ...
                                    {c.status === 'completed' && <span className="text-[#8B7355]">Lõppenud</span>}
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 py-4 border-t border-[#FAF7F2]">
                           ...
                           <div>
                              ...
                              <div className="font-bold text-[#2D2721] text-lg">{c.sales}€</div>
                           </div>
                           <div>
                     ...
                     {c.status === 'active' && (
                        <div className="bg-[#FAF7F2] px-5 py-3 flex items-center justify-between text-xs">
                           <span className="font-bold text-[#8B7355]">Eelarve kasutus ({c.spent}€ / {c.budget}€)</span>
         ...
         <div className="space-y-6">
                ...
                <div className="flex-1 -ml-4">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={CHART_DATA}>
                      ...
                      />
                      <Area type="monotone" dataKey="value" name="Käesolev nädal" stroke="#00D098" strokeWidth={3} fillOpacity={1} fill="url(#colorValue)" />
                      <Area type="monotone" dataKey="prev" name="Eelmine nädal" stroke="#8B7355" strokeWidth={2} strokeDasharray="5 5" fillOpacity={1} fill="url(#colorPrev)" />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
             </WarmCard>
             ...
             <div className="bg-gradient-to-br from-[#FFF9ED] to-[#FFE5B4] border border-[#FFC857] p-5 rounded-2xl shadow-sm relative overflow-hidden">
                ...
                <p className="text-sm text-[#6B5744] leading-relaxed relative z-10 mb-4">
                   ...
                   Soovitame pikendada kampaaniat 3 päeva võrra.
                </p>
