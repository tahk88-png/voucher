...
const CAMPAIGNS_DATA = [
  ...
  {
    id: 2,
    name: "Uudiskiri: Uus Sony Kaamera",
    type: "email",
    status: "completed",
    reach: 5400,
    clicks: 890,
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold text-[#2D2721]">
            Turunduskampaaniad
          </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <WarmCard
          padding="md"
          className="bg-[#2D2721] text-white col-span-1 md:col-span-1"
        >
          ...
          <div className="text-xs text-[#00D098] bg-[#00D098]/10 px-2 py-1 rounded-full inline-block">
            +12% vs eelmine kuu
          </div>
        </WarmCard>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            {filteredCampaigns.map((c) => (
              <WarmCard
                key={c.id}
                padding="none"
                className="bg-white group hover:shadow-lg transition-all border border-[#E7DCC7] overflow-hidden"
              >
                <div className="p-5">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider mt-1">
                          {c.status === "active" && (
                            <span className="text-[#00D098] flex items-center gap-1">
                              <span className="w-1.5 h-1.5 rounded-full bg-[#00D098] animate-pulse"></span>
                              Aktiivne
                            </span>
                          )}
                          {c.status === "paused" && (
            ...
            {filteredCampaigns.length === 0 && (
              <div className="text-center py-12">
                <p className="text-[#6B5744]">
                  Otsingule vastavaid kampaaniaid ei leitud.
                </p>
                <WarmButton
                  variant="outline"
                  className="mt-4"
        ...
        <div className="space-y-6 motion-safe:animate-fade-up">
          ...
          <div className="bg-gradient-to-br from-[#FFF9ED] to-[#FFE5B4] border border-[#FFC857] p-5 rounded-2xl shadow-sm relative overflow-hidden">
            ...
            <WarmButton
              size="sm"
              className="w-full relative z-10 bg-white text-[#2D2721] border border-[#E7DCC7] hover:bg-[#FFF]"
            >
              Rakenda soovitus
            </WarmButton>
          </div>
