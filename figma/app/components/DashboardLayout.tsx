...
import { CountrySelector } from '@/figma/app/components/CountrySelector';
            ...
            <div className="mb-4 p-3 bg-[#FFF9ED] rounded-[12px]">
              ...
              <div className="grid grid-cols-3 gap-1">
                <button
                  ...
                  className={`text-xs py-2 px-2 rounded-lg font-medium transition-all inline-flex items-center justify-center gap-1 ${
                    currentRole === 'user'
