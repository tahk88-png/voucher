...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-[var(--surface)] p-6 shadow-2xl transition ease-spring data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-400",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 border-b rounded-b-[var(--r-xl)] data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
        bottom:
          "inset-x-0 bottom-0 border-t rounded-t-[var(--r-xl)] data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
